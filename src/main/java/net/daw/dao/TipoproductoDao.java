...
public class TipoproductoDao {
	...
	public TipoproductoBean get(int id, int expand) throws Exception {
	...
	public ArrayList<TipoproductoBean> getpage(int iRpp, int iPage, int expand) throws Exception {
