...
//        }
        ...
        $http({
            method: 'GET',
            url: 'json?ob=' + $scope.ob + '&op=getcountxusuario&idfactura=' + $scope.id
        ...
        $http({
            method: 'GET',
            url: 'json?ob=' + $scope.ob + '&op=getpagexusuario&rpp=' + $scope.rpp + '&page=' + $scope.page + '&idfactura=' + $scope.id + $scope.orderURLServidor
        }).then(function (response) {
            $scope.status = response.status;
